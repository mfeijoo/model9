...
class Measure(QMainWindow):
    ...
    def update(self, meas):
        ...
        self.PSmeastp.append(meas[len(dchs)+2]*0.1875/1000*12.961)
        self.minus12Vmeas.append(meas[len(dchs)+3])
        self.minus12Vmeastp.append(meas[len(dchs)+3]*0.1875*2.519/1000)
        self.v5Vmeas.append(meas[len(dchs)+4])
        self.v5Vmeastp.append(meas[len(dchs)+4]*0.1875/1000)
        self.vrefVmeas.append(meas[len(dchs)+5])
        #self.vrefVmeastp.append(meas[len(dchs)+4]*0.187*2.203/1000)
        self.vrefVmeastp.append(meas[len(dchs)+5]*0.1875/1000)   
