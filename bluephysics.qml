...
ApplicationWindow {
    ...
    title: "Blue Physics v9.3.2 file: " + filename.text + '.csv'
    visible: true
        ...
        Row {
            ...
            ToolButton {
                ...
                onClicked: {
                    ...
                    mainmenu.visible = false
                    mainwindow.title = "Blue Physics v9.3.2 analyzing " + filedialog.filename
                }
            }
        ...
        Rectangle {
            ...
            ToolButton {
                ...
                onClicked: {
                    ...
                    mainwindow.title = "Blue Physics v9.3.2 file: " + filename.text + '.csv'
                }
            }
